    ...
    return (
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            <div className="mb-8">
                ...
                <p className="text-gray-600 mt-1">Share announcements, requests, and resources with the community.</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 rounded-lg">
                ...
                {currentUser?.role === 'admin' && (<div className="flex items-center gap-3">
                    <button
            ...
            {loading ? (
                ...
                <div className="text-center text-gray-600">No community posts found.</div>
            ) : (
